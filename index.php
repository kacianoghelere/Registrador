...
<html>
    ...
    <body>
        ...
        <div id="divforms" class="well-small offset5"  align="center" style="width: 500px; background-color:#CDCDCD">
            <form id="frmLogin" action="ajax/logar.php" method="post">
                <fieldset  class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                            
                            <input class="input-xlarge" type="text" id="login" name="login" placeholder="E-mail" value="kaciano_ghelere@yahoo.com.br" style="height: 30px;"></input>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge" type="password" id="senha" placeholder="******" name="senha" value="123456" style="height:30px;"></input>
                        </div>
                    </div>
