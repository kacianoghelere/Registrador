        ...
        $.fn.inputmask = function(fn, options) {
            ...
            function maskScope(masksets, activeMasksetIndex) {
                        ...
                        if ((activeMaskset['lastValidPosition'] == undefined
                            ...
                            if (maskPos >= 0 && maskPos < getMaskLength()) {
                                ...
                                if (result !== false) {
                                    ...
                                    activeMaskset['lastValidPosition'] = isRTL ? pos == getMaskLength() ? undefined : seekNext(pos) : pos == 0 ? undefined : seekPrevious(pos); //autocorrect validposition from backspace etc  	
                ...
                function setBufferElement(buffer, position, element, autoPrepare, isRTL) {
                    if (autoPrepare)
                        position = prepareBuffer(buffer, position, isRTL);
                ...
                this.mask = function(el) {
                    ...
                    function shiftL(start, end, c) {
                        ...
                        while (!isMask(start) && start - 1 >= 0)
                            start--; //jumping over nonmask position
                                                ...
                                                if (opts.insertMode == true) {
                                                    ...
                                                    if (firstUnmaskedPosition <= p && (getActiveMaskSet()['greedy'] || (buffer.length < maskL || getBufferElement(buffer, p) == getPlaceHolder(p)))) {
                                                        if (buffer[firstMaskPos] != getPlaceHolder(firstMaskPos) && buffer.length < maskL) {
                                                            ...
                                                            if ((selectionCleared ? pos.begin : pos.end) != 0)
                                                                p = p + offset;
                                                            maskL = buffer.length;
                                                        }
                                                    ...
                                                    setBufferElement(buffer, p, c, true, isRTL);
                                            }
